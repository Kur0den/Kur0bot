...
async def on_command_error(ctx, error):
    ...
    e.add_field(name='エラー発生したサーバー', value=ctx.message.guild.name, inline=False)
    e.add_field(name='エラー発生したチャンネル', value=ctx.message.channel.name, inline=False)
    e.add_field(name='エラー発生したコマンド', value=ctx.message.content, inline=False)
    e.add_field(name='エラー発生ユーザー名', value=ctx.author, inline=False)
